...
export class HomemadeStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    // 0.5 vCPU / 1 GB. The previous 256/512 (0.25 vCPU) was too starved to
    // render SSR pages before the ALB timed out: on 2026-07-16 TargetResponseTime
    ...
    // and Search Console flagged "Server error (5xx)". This size doubles the
    // compute — enough headroom for crawler bursts while keeping cost low.
