...
- Cooking 1,295 (anchors + pilot-10 + personal-recipe ingest + bulks 001–039). Baking 1,010 (pilot-10 + bulks 001–027 + bulk-004b). Mindset 1,001 (bulks 001–025 + editorial pass — TARGET MET). Herbal-medicine 143 (bulk-001 + bulk-002 + bulk-003 + bulk-004). Fibre arts 556 (bulk-001 through bulk-015). Wood-natural-craft 352 (bulk-001 through bulk-010). Paper & word 546 (bulk-001 through bulk-014). Animals & smallholding 486 (bulk-001 through bulk-017). Home & repair 585 (bulk-001 through bulk-015). Natural home 476 (bulk-001 through bulk-013). Sustainability 608 (bulk-001 through bulk-015). Pottery & ceramics 440 (bulk-001 through bulk-010). **Garden 124** (permaculture batch-01 + vegetables batch-01 + microgreens batch-01). **Needlework 190** (foundations/surface-embroidery/blackwork bulk-001 ×150 + needlepoint bulk-001 ×40). **Crochet 357** (Foundations 57 + Stitches 60 + Motifs 120 + bulk-004 TECHNIQUE ×40 + bulk-005 HOMEWARE ×40 + bulk-006 PATTERN shawls/wraps ×40). **Knitting 244** (K-6 ×150 + K-4.4 ×14 + mitt-glove bulk-001 ×40 + shawl-wrap bulk-002 ×40). The other 3 categories are private placeholders until each crosses 10 published rows.
