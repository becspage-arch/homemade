...
- Cooking 536 (anchors + pilot-10 + personal-recipe ingest + bulks 001–010). Baking 158 (pilot-10 + bulks 001–003). Mindset 20 (bulk-001 — 15 PRACTICE + 5 type-intro READING; first row across the 10-row public threshold). The other 14 categories are private placeholders until each crosses 10 published rows.
