...
- Cooking 536 (anchors + pilot-10 + personal-recipe ingest + bulks 001–010). Baking 158 (pilot-10 + bulks 001–003). Mindset 24 (bulks 001–002 — 19 PRACTICE + 5 type-intro READING). The other 14 categories are private placeholders until each crosses 10 published rows.
...
| 2 | Baking | 3,000 | 158 PUBLISHED (10 pilot + 50 bulk-001 + 50 bulk-002 + 49 bulk-003, 2026-05-17) + 4 DRAFT anchor | ✅ schema + taxonomy + authoring prompt v2 + anti-tells + pilot-10 + bulk-001 + bulk-002 + bulk-003 all landed. **bulk-003 (parallel-burner session, 2026-05-17):** 49 PUBLISHED rotating bread (21) + cakes (20) + scones (3) + biscuits (5) back in after bulk-002's pies/pastries focus. 21 BEGINNER / 24 INTERMEDIATE / 4 ADVANCED. 13 voice-check failures on first run (all em-dash pairs in excerpt/sourceNotes/body) fixed and re-uploaded; 1 ingredient slug miss (lemon-juice not in master table) resolved by removing from no-bake-vanilla-cheesecake. Report: `docs/baking-bulk-003-report.md`. Cumulative sub-category fill: bread 34, cakes 33, pies 19, pastries 20, biscuits 23, scones 15, sweets-confectionery 13, cake-decorating 5. Four anchor DRAFTs pending Rebecca review. Baking-specific TipTap blocks (baker's percentages, lamination schedule, sugar-stage panel) still ahead. | 3 |
