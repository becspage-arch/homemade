...
40 PUBLISHED. Resumed 40 briefs from a failed previous fire (17 already uploaded; 23 uploaded in this session). Sub-categories: cake-decorating ×6, cakes ×9, sweets-confectionery ×8, pies ×6, biscuits ×6, bread ×5. Fixes applied to 6 briefs: sourceType DOCUMENTED→CLASSIC (barbari-iranian-flatbread, georgian-shoti), cold-water ingredient slug (courgette-and-goat-cheese-tart, gooseberry-and-elderflower-tart), grade-level rewrite (crystallised-ginger-homemade), criticalTechniques/techniqueSlugs mismatch (gooseberry-and-elderflower-tart). Voice-check 40/40 pass. QC: 104 processed, pass=104, still_blocked=0. Baking 1,048 → 1,088 (91% of 1,200 target).
