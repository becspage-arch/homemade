...
- Cooking 1,295 (anchors + pilot-10 + personal-recipe ingest + bulks 001–039). Baking 970 (pilot-10 + bulks 001–026 + bulk-004b). Mindset 1,001 (bulks 001–025 + editorial pass — TARGET MET). Herbal-medicine 143 (bulk-001 + bulk-002 + bulk-003 + bulk-004). Fibre arts 556 (bulk-001 through bulk-015). Wood-natural-craft 346 (bulk-001 through bulk-010). Paper & word 506 (bulk-001 through bulk-013). Animals & smallholding 446 (bulk-001 through bulk-016). Home & repair 585 (bulk-001 through bulk-015). Natural home 436 (bulk-001 through bulk-012). Sustainability 568 (bulk-001 through bulk-014, foraging sub-cat live — 16 entries). Pottery & ceramics 322 (bulk-001 through bulk-008). **Garden 84** (permaculture batch-01 + vegetables batch-01). **Needlework 190** (foundations/surface-embroidery/blackwork bulk-001 ×150 + needlepoint bulk-001 ×40). The other 4 categories are private placeholders until each crosses 10 published rows.
...
- Autopilot — wood-natural-craft bulk-010 (autopilot-queue, 2026-06-13): 30 PUBLISHED (316 → 346) — spoon-carving ×5 (carved-sycamore-serving-spoon-long, carved-ash-jam-spoon-short, carved-birch-egg-ladle, carved-maple-salt-spoon [PATTERN ×4], reading-the-grain-for-spoon-carvers [READING ×1]), whittling ×6 (whittled-pine-butter-spreader, whittled-oak-peg-hook, whittled-ash-letter-opener, whittled-walnut-pendant-blank [PATTERN ×4], choosing-wood-for-whittling [READING ×1], thumb-push-cut-technique [TECHNIQUE ×1]), green-woodwork ×8 (riven-ash-stool-leg, shaved-hazel-walking-stick, green-ash-bowl-on-pole-lathe, drawknife-shaved-rake-handle [PATTERN ×4], why-green-wood-works, british-species-for-green-woodwork [READING ×2], using-the-froe-for-riving, shaving-horse-setup-technique [TECHNIQUE ×2]), basketry-willow ×5 (round-willow-bread-basket [PATTERN ×1], selecting-and-soaking-willow, the-parts-of-a-basket [READING ×2], pairing-weave-technique, waling-technique [TECHNIQUE ×2]), seasoned-wood ×7 (oak-end-grain-serving-board, cherry-butter-dish, walnut-cheese-board, ash-chopping-board [PATTERN ×4], card-scraper-technique, danish-oil-finishing-technique, mortise-tenon-joint-technique [TECHNIQUE ×3]). Voice-check fixes: medical-claim "cures"→"hardens" (4 files), em-dash removal (5 files), grade-level rewrites (6 files), glossary-coverage wraps (8 files), invalid sourceType ORIGINAL→SYNTHESISED/CLASSIC. Heroes: 29 filled (Pexels/Unsplash/Wikimedia), 2 unset (flux billing halt + no-match). QC: 28 pass, 2 still_blocked (hero-missing, picked up by hourly routine). This fire ran on Claude Sonnet 4.6. Report: docs/wood-natural-craft-bulk-010-report.md.
...
| | **Total** | **31,700** | **1,528** | ~12 wks setup outstanding (new categories) + ~3 wks Cooking sub-extensions | ~28 weeks fill |
