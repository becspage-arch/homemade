...
| 5 | Mindset | 4,300 | 254 PUBLISHED (bulks 001–007) | ✅ schema + backlog + authoring prompt v3 + anti-tells (24 entries, updated bulk-007) + 11 sub-categories. **bulk-007 (autopilot-queue, 2026-05-18):** 46 entries PUBLISHED — MONEY Days 22–28 + SLEEP Day 15. Practice mix: TAPPING x8, ENERGY_STATEMENT x9, AFFIRMATION x6, VISUALISATION x8, JOURNAL_PROMPT x7, RITUAL x2, READING x2, EMBODIMENT x1, MEDITATION x1, ACTIVITY x2. 15 voice-check fixes: em-dash pairs (14 files), banned phrases (2 files), medical watchword (2 files). Mindset 208 → 254. Report: `docs/mindset-bulk-007-report.md`. | 4.3 |
