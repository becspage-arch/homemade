...
- Cooking 1,295 (anchors + pilot-10 + personal-recipe ingest + bulks 001–039). Baking 970 (pilot-10 + bulks 001–026 + bulk-004b). Mindset 1,001 (bulks 001–025 + editorial pass — TARGET MET). Herbal-medicine 102 (bulk-001 + bulk-002 + bulk-003). Fibre arts 517 (bulk-001 through bulk-014). Wood-natural-craft 276 (bulk-001 through bulk-008). Paper & word 506 (bulk-001 through bulk-013). Animals & smallholding 406 (bulk-001 through bulk-015). Home & repair 505 (bulk-001 through bulk-013). Natural home 402 (bulk-001 through bulk-011). Sustainability 529 (bulk-001 through bulk-013). Pottery & ceramics 282 (bulk-001 through bulk-007). The other 6 categories are private placeholders until each crosses 10 published rows.
...
- Crochet D-Lacework bulk seed (2026-06-10). 110 patterns published to `crochet/lacework` on branch `claude/busy-bohr-a09996`. Breakdown: Tunisian variants ×10 (simple-stitch-blanket, smock-stitch-cowl, honeycomb-cushion, full-stitch-bag, entrelac-scarf, lace-stitch-wrap, knit-stitch-hat, cable-stitch-headband, mesh-stitch-market-bag, reverse-stitch-tablet-case), broomstick lace ×10 (scarf, shawl, cowl, hat, bag, baby-blanket, wrist-warmers, vest, cushion-cover, table-runner), hairpin lace ×10 (baby-blanket, cowl, scarf, shawl, table-runner, wrap, bookmark, headband, wall-hanging, cushion-cover), Irish crochet ×12 (leaf-motif, flower-motif, collar, rose-brooch, bag, bookmark, cuff, butterfly-motif, square-motif, sampler, headband, bookmark-set), doilies ×12 (classic-round, pineapple, star, oval, sunflower, square, vintage-spider-web, snowflake, heart, large-centrepiece, butterfly, filet-square), lace edgings ×11 (picot, shell, fan, scallop, double-picot, leaf, bullion, vintage-tatting-look, floral-lace-trim, pineapple, pointed). Voice-check: all 110 passed (exit 0 or exit 1 warnings-only); main fixes were em-dash replacements and brand-trademark false positives on "anchor" as a verb (warning-level, did not block upload). All uploaded as PUBLISHED.
