...
- Cooking 1065 (anchors + pilot-10 + personal-recipe ingest + bulks 001–028). Baking 552 (pilot-10 + bulks 001–014 + bulk-004b). Mindset 684 (bulks 001–017 + editorial pass). The other 14 categories are private placeholders until each crosses 10 published rows.
...
| 5 | Mindset | 4,300 | 438 PUBLISHED (bulks 001–011 + editorial pass) | ✅ schema + backlog + authoring prompt v4 + anti-tells + 11 sub-categories. **bulk-011 (autopilot-queue, 2026-05-18):** 43 entries PUBLISHED — MONEY Days 50–56 + SLEEP Days 22–24. 8 voice-check fixes. Mindset 395 → 438. Report: `docs/mindset-bulk-011-report.md`. | 4.3 |
