...
**Word precision for Crochet.** The correct verbs are: "crocheting", "working",
"making", "joining", "fastening off". Not "sewing", not "knitting". Stitches are
"worked", not "sewn" or "knitted".
...
2. **Safety advice — max one line.** No multi-paragraph safety sections. No PPE lists
   in the body. Safety steps (e.g. wrist care) go inline as numbered steps.
3. **No false specificness.** No brand-pinned yarn names unless the yarn type is
   critical (e.g. "double knit" is specific enough; a brand name is not needed).
4. **Word precision.** Use only crochet verbs above. Rewrite any borrowed verb.
