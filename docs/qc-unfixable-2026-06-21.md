...
- steak-and-kidney-pie hero-missing — applied: hero-fill-deferred-to-standalone-script
...
- coq-au-vin prose-prep-steps — applied: 
- cornish-pasty prose-prep-steps — applied: 
...
- soupe-a-loignon prose-prep-steps — applied: 
...
- acai-bowl hero-missing — applied: hero-fill-deferred-to-standalone-script
- ajiaco-bogotano prose-prep-steps — applied: 
- alfajores hero-missing — applied: hero-fill-deferred-to-standalone-script
- arroz-con-leche-peruano hero-missing — applied: hero-fill-deferred-to-standalone-script
- bandeja-paisa hero-missing — applied: hero-fill-deferred-to-standalone-script
- brigadeiro hero-missing — applied: hero-fill-deferred-to-standalone-script
- broccoli-and-stilton-soup prose-prep-steps — applied: 
- bunuelos-colombianos hero-missing — applied: hero-fill-deferred-to-standalone-script
- cauliflower-and-cheese-soup prose-prep-steps — applied: 
- chimichurri hero-missing — applied: hero-fill-deferred-to-standalone-script
- coxinha hero-missing — applied: hero-fill-deferred-to-standalone-script
- doenjang-jjigae prose-prep-steps — applied: 
- dulce-de-leche hero-missing — applied: hero-fill-deferred-to-standalone-script
- empanadas-carne hero-missing — applied: hero-fill-deferred-to-standalone-script
- guacamole prose-prep-steps — applied: 
- huevos-rancheros hero-missing — applied: hero-fill-deferred-to-standalone-script
- medialunas hero-missing — applied: hero-fill-deferred-to-standalone-script
- pea-and-mint-soup prose-prep-steps — applied: 
- poached-eggs prose-prep-steps — applied: 
- pozole-rojo hero-missing — applied: hero-fill-deferred-to-standalone-script
- roasted-red-pepper-soup prose-prep-steps — applied: 
- sancocho-dominicano hero-missing — applied: hero-fill-deferred-to-standalone-script
- slow-cooker-chickpea-curry prose-prep-steps — applied: 
- slow-cooker-lamb-shanks prose-prep-steps — applied: 
- slow-cooker-vegetable-soup prose-prep-steps — applied: 
- sopa-de-lima hero-missing — applied: hero-fill-deferred-to-standalone-script
- suspiro-de-limena hero-missing — applied: hero-fill-deferred-to-standalone-script
- tres-leches-cake hero-missing — applied: hero-fill-deferred-to-standalone-script

- arepas-colombianas hero-missing — applied: hero-fill-deferred-to-standalone-script
- cochinita-pibil hero-missing — applied: hero-fill-deferred-to-standalone-script
- horchata hero-missing — applied: hero-fill-deferred-to-standalone-script
- lomo-saltado hero-missing — applied: hero-fill-deferred-to-standalone-script
- pao-de-queijo hero-missing — applied: hero-fill-deferred-to-standalone-script
- picarones hero-missing — applied: hero-fill-deferred-to-standalone-script
...
- pad-thai hero-missing — applied: hero-fill-deferred-to-standalone-script
...
- massaman-curry hero-missing — applied: hero-fill-deferred-to-standalone-script
...
- cullen-skink prose-prep-steps — applied: 
...
- biryani-chicken hero-missing — applied: hero-fill-deferred-to-standalone-script
- butter-chicken hero-missing — applied: hero-fill-deferred-to-standalone-script
- egusi-soup hero-missing — applied: hero-fill-deferred-to-standalone-script
- lancashire-hotpot hero-missing — applied: hero-fill-deferred-to-standalone-script

- beef-bourguignon prose-prep-steps — applied: 
- beef-rendang prose-prep-steps — applied: 
- bolognese prose-prep-steps — applied: 
- chelsea-buns prose-prep-steps — applied: 
...
- hot-cross-buns prose-prep-steps — applied: 
- kedgeree-smoked-salmon prose-prep-steps — applied: 
...
- beef-stroganoff prose-prep-steps — applied: 
- borscht prose-prep-steps — applied: 
- cassoulet prose-prep-steps — applied: 
- cauliflower-cheese prose-prep-steps — applied: 
...
- minestrone prose-prep-steps — applied: 
- pea-and-mint-risotto prose-prep-steps — applied: 
- rock-cakes prose-prep-steps — applied: 
- senegalese-thieboudienne prose-prep-steps — applied: 
- waakye prose-prep-steps — applied: 

- chicken-soup prose-prep-steps — applied: 
- fish-pie prose-prep-steps — applied: 
- green-thai-curry prose-prep-steps — applied: 
- liver-and-bacon prose-prep-steps — applied: 
- onion-soup-gratinee prose-prep-steps — applied: 
- prawn-chowder prose-prep-steps — applied: 
- pulled-pork prose-prep-steps — applied: 
- rabbit-stew prose-prep-steps — applied: 

- leek-potato-soup prose-prep-steps — applied: 
- mushroom-soup prose-prep-steps — applied: 
- naan-bread prose-prep-steps — applied: 
- tarte-tatin hero-missing — applied: hero-fill-deferred-to-standalone-script
- tiramisu hero-missing,prose-prep-steps — applied: hero-fill-deferred-to-standalone-script
...
- yorkshire-pudding hero-missing — applied: hero-fill-deferred-to-standalone-script

- banh-canh prose-prep-steps — applied: 
- banh-cuon prose-prep-steps — applied: 
- canh-chua prose-prep-steps — applied: 
- causa-limena prose-prep-steps — applied: 
- enchiladas prose-prep-steps — applied: 
- hoppin-john prose-prep-steps — applied: 
- lau grade-level-strict — applied: 
- mapo-pork prose-prep-steps — applied: 
- mien-ga prose-prep-steps — applied: 
- pho-ga prose-prep-steps — applied: 
- sweetcorn-fritters prose-prep-steps — applied: 

- agedashi-tofu prose-prep-steps — applied: 
- beef-tacos prose-prep-steps — applied: 
- chana-masala prose-prep-steps — applied: 
- chicken-and-dumplings prose-prep-steps — applied: 
- chickpea-tikka-masala prose-prep-steps — applied: 
- dhansak prose-prep-steps — applied: 
- empanadas-beef prose-prep-steps — applied: 
- hoisin-pork-lettuce-wraps prose-prep-steps — applied: 
- korma prose-prep-steps — applied: 
- minestrone-genovese prose-prep-steps — applied: 
- paneer-butter-masala prose-prep-steps — applied: 
- pasta-e-fagioli grade-level-strict — applied: 
- pastitsio prose-prep-steps — applied: 
- rajma prose-prep-steps — applied: 
- ratatouille-tian grade-level-strict — applied: 
- shakshuka-with-chorizo prose-prep-steps — applied: 
- strozzapreti-al-ragu prose-prep-steps — applied: 
- sweet-potato-curry prose-prep-steps — applied: 
- trofie-al-pesto voice-violation,grade-level-strict — applied: 

- tonkatsu hero-missing — applied: hero-fill-deferred-to-standalone-script
- yakitori hero-missing — applied: hero-fill-deferred-to-standalone-script

- blanquette-de-veau prose-prep-steps — applied: 
- bouillabaisse prose-prep-steps — applied: 
- cabbage-rolls prose-prep-steps — applied: 
- chicken-paprikash grade-level-strict — applied: 
- chilli-con-carne prose-prep-steps — applied: 
- cornmeal-porridge prose-prep-steps — applied: 
- curried-goat prose-prep-steps — applied: 
- dashimaki-tamago prose-prep-steps — applied: 
- erbsensuppe prose-prep-steps — applied: 
- harira prose-prep-steps — applied: 
- irish-stew prose-prep-steps — applied: 
- laksa prose-prep-steps — applied: 
- nikujaga prose-prep-steps — applied: 
- oxtail-stew prose-prep-steps — applied: 
- pepperpot prose-prep-steps — applied: 
- sauerbraten prose-prep-steps — applied: 

- adobo-chicken hero-missing — applied: hero-fill-deferred-to-standalone-script
- aubergine-parmigiana prose-prep-steps — applied: 
- caprese-salad prose-prep-steps — applied: 
- char-kway-teow hero-missing — applied: hero-fill-deferred-to-standalone-script
- empanadas prose-prep-steps — applied: 
- gado-gado hero-missing — applied: hero-fill-deferred-to-standalone-script
- halo-halo hero-missing — applied: hero-fill-deferred-to-standalone-script
- jeyuk-bokkeum prose-prep-steps — applied: 
- kare-kare hero-missing,prose-prep-steps — applied: hero-fill-deferred-to-standalone-script
- larb-gai hero-missing — applied: hero-fill-deferred-to-standalone-script
- lechon-kawali hero-missing,prose-prep-steps — applied: hero-fill-deferred-to-standalone-script
- mast-musir prose-prep-steps — applied: 
- mie-goreng hero-missing — applied: hero-fill-deferred-to-standalone-script
- nasi-goreng hero-missing — applied: hero-fill-deferred-to-standalone-script
- pad-see-ew hero-missing — applied: hero-fill-deferred-to-standalone-script
- prawn-bisque prose-prep-steps — applied: 
- red-curry hero-missing — applied: hero-fill-deferred-to-standalone-script
- rendang hero-missing — applied: hero-fill-deferred-to-standalone-script
- satay-ayam hero-missing — applied: hero-fill-deferred-to-standalone-script
- sinigang hero-missing — applied: hero-fill-deferred-to-standalone-script
- spiced-broccoli-soup prose-prep-steps — applied: 
- steak-diane prose-prep-steps — applied: 
- sundubu-jjigae prose-prep-steps — applied: 
- tom-kha-gai hero-missing,prose-prep-steps — applied: hero-fill-deferred-to-standalone-script
- tom-yum-goong hero-missing,prose-prep-steps — applied: hero-fill-deferred-to-standalone-script
- waterzooi prose-prep-steps — applied: 

- arroz-con-pollo prose-prep-steps — applied: 
- beef-goulash prose-prep-steps — applied: 
- beef-shin-stew-dumplings prose-prep-steps — applied: 
- chicken-hunter-stew prose-prep-steps — applied: 
- chicken-provencal prose-prep-steps — applied: 
- congee prose-prep-steps — applied: 
- coronation-chicken prose-prep-steps — applied: 
- dashimaki-tamago-soup prose-prep-steps — applied: 
- feijoada prose-prep-steps — applied: 
- keema-naan prose-prep-steps — applied: 
- mapo-tofu prose-prep-steps — applied: 
- paneer-saag prose-prep-steps — applied: 
- pernil grade-level-strict — applied: 
- pho prose-prep-steps — applied: 
- pork-ramen prose-prep-steps — applied: 
- ramen prose-prep-steps — applied: 
- sandesh prose-prep-steps — applied: 
- spinach-and-chickpea-stew prose-prep-steps — applied: 
- tom-yum-soup prose-prep-steps — applied: 

- beef-wellington prose-prep-steps — applied: 
- butter-bean-stew prose-prep-steps — applied: 
- chicken-cordon-bleu prose-prep-steps — applied: 
- devilled-kidneys prose-prep-steps — applied: 
- kibbeh-baked prose-prep-steps — applied: 
- lamb-meatballs-in-tomato-sauce prose-prep-steps — applied: 
- pot-au-feu prose-prep-steps — applied: 

- chimichurri-sauce prose-prep-steps — applied: 
- maids-of-honour hero-missing,opening-pattern-missing-hook — applied: hero-fill-deferred-to-standalone-script,recipe-yield-appended
- mulligatawny hero-missing,prose-prep-steps — applied: hero-fill-deferred-to-standalone-script
- roast-shoulder-of-pork hero-missing — applied: hero-fill-deferred-to-standalone-script
- slow-cooker-bolognese-sauce hero-missing — applied: hero-fill-deferred-to-standalone-script
- slow-cooker-chicken-cacciatore hero-missing — applied: hero-fill-deferred-to-standalone-script
- slow-cooker-chilli-con-carne hero-missing — applied: hero-fill-deferred-to-standalone-script
- slow-cooker-gammon-glazed hero-missing — applied: hero-fill-deferred-to-standalone-script
- slow-cooker-lamb-rogan-josh hero-missing — applied: hero-fill-deferred-to-standalone-script
- slow-cooker-lentil-chilli hero-missing — applied: hero-fill-deferred-to-standalone-script
- slow-cooker-mushroom-stroganoff hero-missing — applied: hero-fill-deferred-to-standalone-script
- slow-cooker-rice-pudding hero-missing — applied: hero-fill-deferred-to-standalone-script
- slow-cooker-whole-roast-chicken hero-missing — applied: hero-fill-deferred-to-standalone-script
