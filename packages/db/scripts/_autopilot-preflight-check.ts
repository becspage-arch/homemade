/**
 * Temporary preflight helper for autopilot-queue-extra.
 * Checks pause states and category round-robin candidates.
 */
...
async function main() {
  ...
  const pauses = await prisma.autopilotPauseState.findMany()
  console.log('PAUSE_STATE:' + JSON.stringify(pauses))
