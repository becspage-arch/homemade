 ...
 * batch 2026-05-28-batch3 (the 46th overall fire).
 *
 * Selection rules:
...
const BATCH_ID = '2026-05-28-batch3'
const TARGET_COUNT = 63
const MAX_PER_CATEGORY = 21

// Slugs blocked by the verbatim-energy-statements rule. Includes the
// running set from batch40-43, batch44 (in batch45 pick), plus the 3
// verbatim-blocked slugs dropped during batch2 apply on 2026-05-28.
