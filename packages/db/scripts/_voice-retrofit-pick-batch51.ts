 ...
 * batch 2026-05-28-batch8 (the 51st overall fire).
 *
 * Selection rules:
...
// Slugs blocked by the verbatim-energy-statements rule.
const KNOWN_BLOCKED = new Set<string>([
  ...
  // From 2026-05-28 batch2 hand-off
  ...
  // From 2026-05-28 batch8 hand-off
  // Activation contains a verbatim affirmation from MONEY Journal Week 7
  // (Anchor blockquote) that scores grade 12.4. Per verbatim-energy-statements
  // rule the affirmation cannot be rewritten; voice-check therefore blocks
  // the file. Skip from future picks.
