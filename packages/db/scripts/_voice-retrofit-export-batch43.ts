/**
 * Export the batch43 PUBLISHED tutorial bodies to JSON files at
 * docs/voice-retrofit-2026-05-27-batch43/<slug>.json. The shape matches
 * what _pilot-voice-apply.ts expects.
 *
 * Run after _voice-retrofit-pick-batch43.ts has written _slugs.json.
 */
