...
export const TOOLS: ToolSeed[] = [
  ...
  //
  // Soap, candle, balm, and lotion work runs on weights and percentages.
  // The 0.1 g scale, probe thermometer, immersion blender, silicone
  // mould, and PPE pieces are the kit every recipe assumes. Where a tool
  // already exists from the cooking / herbal kit (double-boiler,
  // muslin-cloth, salve-tin, thermometer-probe, measuring-jug,
  // funnel-small, digital-scales, stick-blender) we reuse it. The new
  // entries below are the bits the existing kit doesn't already cover.
  // ────────────────────────────────────────────────────────────────────────

  { slug: 'digital-scale-precision', name: 'Digital scale, 0.1 g precision', category: 'scale', aliases: ['jewellery scale', 'precision scale'], isPurchasable: true, typicalPriceGbp: 1800, notes: 'Cosmetic / soap-making precision scale, 0.1 g resolution, 500-2000 g range. Essential — eyeballing lye weights gets you a caustic bar. The kitchen-scale 1 g resolution is too coarse for cosmetic-active dosing.' },
  { slug: 'safety-goggles', name: 'Safety goggles, splash-rated', category: 'other', aliases: ['chemistry goggles', 'splash goggles'], isPurchasable: true, typicalPriceGbp: 800, notes: 'Splash-rated indirectly-vented goggles for lye work. Standard safety glasses are not enough — lye splashes go in around the edges. Worn whenever the lye container is open.' },
  { slug: 'nitrile-gloves', name: 'Nitrile gloves', pluralName: 'nitrile gloves', category: 'other', aliases: ['chemical-resistant gloves'], isPurchasable: true, typicalPriceGbp: 1500, notes: 'Chemical-resistant nitrile gloves (8-mil or thicker) for lye work. Latex is not lye-resistant; standard washing-up gloves are too thin. A box of 100 lasts several batches.' },
  { slug: 'lye-pitcher-hdpe', name: 'HDPE lye pitcher, 1 L', category: 'other', aliases: ['lye jug'], isPurchasable: true, typicalPriceGbp: 600, notes: 'High-density polyethylene (HDPE, recycling symbol #2) jug reserved for lye solution. Never glass — lye boils on contact with water and thermal shock can crack glass. Label clearly; never reuse for food.' },
  { slug: 'silicone-loaf-mould', name: 'Silicone loaf mould (soap)', category: 'tin', aliases: ['silicone soap mould'], isPurchasable: true, typicalPriceGbp: 1500, notes: 'Food-grade silicone loaf mould, ~1 kg capacity (the standard cold-process soap batch size). Easy unmould after 24-48 hours; no liner required.' },
  { slug: 'soap-cutter-wire', name: 'Soap cutter (wire / multi-bar)', category: 'utensil', aliases: ['cheese-wire soap cutter', 'multi-bar cutter'], isPurchasable: true, typicalPriceGbp: 3000, notes: 'Single-wire cheese-wire cutter or multi-bar wooden mitre box. Either works; the multi-bar gets you even bars in one pass. A sharp chef\'s knife is the budget alternative.' },
  { slug: 'candle-pouring-pitcher', name: 'Candle pouring pitcher (aluminium)', category: 'pot', aliases: ['wax-melting pitcher'], isPurchasable: true, typicalPriceGbp: 1200, notes: 'Aluminium pouring pitcher with a spout, 1-1.5 L capacity, dedicated to candle work. Sits inside a saucepan as a double-boiler. The spout makes wick-aligned pours much easier than a saucepan.' },
  { slug: 'wick-centring-bar', name: 'Wick centring bar', category: 'utensil', aliases: ['wick holder', 'centring tool'], isPurchasable: true, typicalPriceGbp: 400, notes: 'Slotted metal or wood bar that sits across a candle jar to hold the wick centred while the wax sets. Chopsticks held with a rubber band do the same job for one or two candles.' },
  { slug: 'amber-glass-bottle-100ml', name: 'Amber glass bottle, 100 ml', pluralName: 'amber glass bottles', category: 'other', aliases: ['amber dropper bottle'], isPurchasable: true, typicalPriceGbp: 300, notes: 'UV-resistant amber glass for finished lotions, sprays, and oil blends. The amber tint protects light-sensitive cosmetic actives. Pair with a pump dispenser, dropper, or spray top.' },
  { slug: 'pump-dispenser-100ml', name: 'Pump dispenser top, 24/410', category: 'other', aliases: ['lotion pump'], isPurchasable: true, typicalPriceGbp: 200, notes: '24/410 standard cosmetic pump for amber bottles up to 100 ml. The neck thread is the standard size; bigger bottles use 28/410.' },
  { slug: 'lotion-mixing-jug', name: 'Lotion mixing jug (heatproof glass)', category: 'measuring', aliases: ['Pyrex measuring jug, dedicated'], isPurchasable: true, typicalPriceGbp: 900, notes: 'Heatproof glass jug dedicated to cosmetic work. Survives the immersion-blender stick and the 70°C oil + water phases of a basic emulsion.' },
  { slug: 'ph-test-strips', name: 'pH test strips (cosmetic range)', pluralName: 'pH test strips', category: 'measuring', aliases: ['cosmetic pH paper'], isPurchasable: true, typicalPriceGbp: 700, notes: 'Narrow-range (3-12 pH) test strips for finished soap and lotion checks. A cured cold-process soap reads 9-10; a finished lotion targets 4.5-5.5. Cheap paper strips are good enough at the home-batch scale.' },
  { slug: 'spray-bottle-amber-250ml', name: 'Amber spray bottle, 250 ml', pluralName: 'amber spray bottles', category: 'other', aliases: ['trigger-spray bottle'], isPurchasable: true, typicalPriceGbp: 350, notes: 'Trigger-spray amber bottle for surface sprays and air fresheners. Glass is preferable over plastic for essential-oil-rich recipes (some EOs degrade soft plastics over time).' },
]
