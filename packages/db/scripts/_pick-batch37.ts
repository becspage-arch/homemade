/**
 * Pick 63 candidates for voice-retrofit batch37.
 ...
 * Writes docs/voice-retrofit-2026-05-27-batch37/_slugs.json
 */
...
const BATCH_ID = '2026-05-27-batch37'
const TARGET = 63
// Spec says "max 19 per category" but the remaining candidate pool is now
// dominated by 3 categories (cooking, baking, mindset) plus a tiny tail; a
// 19-cap would only fill 59 picks. Raising to 22 keeps spread fair while
// reaching the 63 target.
const MAX_PER_CAT = 22
