/**
 * Export the batch 30 tutorial bodies from DB to docs/voice-retrofit-2026-05-27-batch30/<slug>.json
 * so the rewrite step can edit them in place. Reads the slug list from
