...
export const BRIEFS: Brief[] = [
  ...
  B('07021422', 'b07021422-cute-gosling', 116, 118, 16, 'cute', 'an adorable fluffy yellow baby gosling standing on a solid patch of bright green grass with a few little white daisies, a soft downy round body with a bold clear dark outline drawn all the way around the whole body, head and little webbed feet so it reads crisply on pale fabric, a sweet face with two clearly separated round dark eyes symmetrical and a small orange beak, bright and cheerful, clean white background, strong and crisp NOT washed-out NOT hazy'),
  B('07021422', 'b07021422-cute-kid-goat', 118, 118, 16, 'cute', 'an adorable fluffy white baby goat kid standing on a solid patch of bright green grass with a few little flowers, facing towards the viewer with both round dark eyes clearly visible and symmetrical and a little pink nose, a soft cream-white body with a VERY BOLD thick solid dark charcoal-brown outline drawn heavily as one strong continuous dark line all the way around the entire body, head, ears and legs so the whole cream body stands out sharply and high-contrast and NO part of the body edge fades or ghosts into the pale background, tiny nubby horns, a little blue ribbon bell collar for a spot of colour, plain white background, strong bold crisp and high-contrast NOT washed-out NOT faded'),
  B('07021422', 'b07021422-cute-squirrel-acorn', 118, 118, 17, 'cute', 'an adorable fluffy grey squirrel sitting up and holding a brown acorn in both little paws, a soft silver-grey body and big bushy grey tail with a bold clear dark outline so it reads clearly on pale fabric, a sweet round face with both eyes symmetrical and a tiny nose, a few autumn leaves at its feet, bright and cheerful, clean white background'),
  B('07021422', 'b07021422-popart-fro-man', 155, 200, 22, 'popart', 'a handsome man with a neat rounded short afro and stylish thick-rimmed glasses, his face large and clearly centred and filling the frame with correct human proportions, both eyes clearly drawn, symmetrical, level and evenly spaced, each eye looking straight ahead at the viewer with the dark-brown iris and a single round black pupil centred in the MIDDLE of the eye (absolutely NOT cross-eyed, NOT looking sideways, pupils NOT shoved into the inner corners, NOT blank white eyes), clearly drawn dark eyebrows, a clearly defined nose with a visible bridge and nostrils, defined lips and a short neat beard, all facial features clearly and boldly outlined and fully visible on the dark skin, a calm confident expression, a smooth clear brown neck below the face, rich dark chocolate-brown skin (deep and clearly brown, absolutely not pink coral or orange), deep mustard-gold background', 1.1),
  B('07021422', 'b07021422-popart-ponytail-woman', 150, 195, 20, 'popart', 'a stylish young woman with light brown hair pulled back into a high sleek ponytail and small gold hoop earrings, a warm friendly smile, her face clearly centred with correct proportions and both eyes symmetrical, clean smooth EVEN fair skin in a natural believable tone under bright FLAT even frontal lighting, soft flat even shading with absolutely NO grey or green blotches or contouring patches anywhere on the face or neck and NOT orange, dusty rose-pink background', 1.0),
  B('07021422', 'b07021422-face-cornflower-fair', 160, 205, 26, 'artface', 'a woman with fair skin and a crown of bright blue cornflowers and small white daisies with slender green foliage, a serene beautiful face in bright FLAT even frontal studio lighting with absolutely NO grey or green contouring shadows, clean smooth matte even fair skin in a warm healthy tone, the whole head and full forehead clearly visible above the brows, both eyes symmetrical and bright with NO dark hollows underneath, soft flat even shading, no grey or green patches anywhere on the face or neck, natural clean skin', 1.0),
  B('07021422', 'b07021422-fantasy-fairy-lily', 145, 175, 30, 'fantasy', 'a pretty little water fairy with fair skin, delicate translucent wings and a soft petal dress sitting on a large pink water lily on a sunny pond with lily pads, cattails and darting dragonflies, a clear well-defined pretty face with a small nose and a sweet smile and two NORMAL-SIZED eyes (definitely NOT huge, NOT oversized), each eye with a clearly drawn coloured iris and a distinct dark round pupil and a small white highlight (absolutely NOT blank empty eyes, NOT solid green orbs), both eyes symmetrical, bright vivid HIGH-CONTRAST luminous turquoise-and-pink colours, crisp clean BOLD outlines, NOT hazy NOT washed-out NOT muddy'),
  B('07021422', 'b07021422-fantasy-mermaid-seahorse', 145, 175, 30, 'fantasy', 'a pretty little mermaid with fair skin and a shimmering purple tail riding on the back of a friendly golden seahorse through a bright coral reef with starfish and rising bubbles, a clear well-defined pretty face with a sweet friendly expression and both eyes symmetrical and NORMAL-SIZED, a strong bold outline so the figures read sharply, bright vivid turquoise and coral jewel tones, crisp clean BOLD high-contrast outlines, NOT muddy NOT hazy'),
  B('07021422', 'b07021422-scene-panda-painter', 150, 190, 30, 'scene', 'a cheerful black-and-white panda artist in a paint-smudged smock and beret standing at a wooden easel painting a bright landscape, a palette of colourful paints in one paw, jars of brushes and a stool beside, a sunny studio with a big window and potted plants, warm and whimsical, blank canvas with no lettering'),
  B('07021422', 'b07021422-scene-frog-gardener', 150, 190, 30, 'scene', 'a friendly little green frog gardener in dungarees and a straw hat tending a neat cottage flower bed with tall foxgloves, daisies and a small pond, a green watering can, a wheelbarrow of pots and a garden fork, sunny and whimsical, blank signs with no lettering'),
  B('07021422', 'b07021422-bright-great-tit', 150, 170, 30, 'bright', 'a single plump great tit bird with a bright lemon-yellow breast, glossy black head with white cheeks, blue-grey wings and a black chest stripe, perched clearly on ONE simple branch to one side with a bold clean dark outline so the whole bird reads sharply against a clean plain white background, just two or three green leaves attached to that same branch, absolutely NO floating disconnected leaves and NO stray smudges, clean uncluttered composition, crisp and clear'),
  B('07021422', 'b07021422-big-tulip-windmill', 240, 220, 150, 'showpiece', 'a vast Dutch spring landscape with a traditional windmill beside a canal, rows upon rows of vivid red, yellow, pink and purple tulip fields stretching to the horizon, blossoming trees, a little arched bridge, bicycles, wooden clogs and a bright blue sky with puffy clouds, intricate richly-coloured full coverage'),
  B('07021422', 'b07021422-big-harbour-town', 235, 220, 150, 'showpiece', 'a pretty coastal fishing harbour at golden hour with rows of colourful quayside cottages climbing the hillside, little painted fishing boats moored on calm water with mirror reflections, a white lighthouse on the headland, wheeling gulls, stacked lobster pots and hanging nets, warm glowing sky, intricate saturated full coverage'),

  B('07031525', 'b07031525-cute-fennec-kit', 116, 118, 16, 'cute', 'an adorable fluffy baby fennec fox with enormous rounded ears sitting on a solid patch of warm sandy desert ground with a few tiny green succulents, a soft pale cream-and-sand body with a VERY BOLD thick solid dark charcoal-brown outline drawn heavily as one strong continuous dark line all the way around the entire body, head, big ears and legs so the whole pale body stands out sharply against the pale fabric and NO part of the body edge fades or ghosts into the background, a sweet round face with two clearly separated round dark eyes symmetrical and a tiny black nose, bright and cheerful, plain white background, strong bold crisp and high-contrast NOT washed-out NOT faded'),
  B('07031525', 'b07031525-cute-cygnet', 116, 118, 16, 'cute', 'an adorable fluffy grey-and-white baby swan cygnet sitting on a small patch of calm bright blue water with a few little green lily pads, facing towards the viewer with BOTH round dark eyes clearly visible symmetrical and level and a small dark beak, a soft clean downy round body with a VERY BOLD thick solid dark charcoal outline drawn heavily as one strong continuous dark line all the way around the whole body, head and neck so the pale body reads crisply on pale fabric and NO edge fades into the background, absolutely no muddy grey shadow patches on the body, bright and cheerful, plain white background, strong and crisp NOT washed-out NOT hazy NOT muddy'),
  B('07031525', 'b07031525-cute-snowy-owlet', 118, 118, 17, 'cute', 'an adorable fluffy round baby snowy owl chick sitting on a small patch of solid soft pale-blue snow with a few tiny green sprigs, a soft fluffy white-and-pale-grey body with a VERY BOLD thick solid dark charcoal outline drawn heavily as one strong continuous dark line all the way around the entire round body, head and ear tufts so the pale body stands out sharply on the pale fabric and NO part of the edge fades into the background, a sweet round face with two big clearly separated round dark eyes symmetrical and level and a tiny beak, bright and cheerful, plain white background, strong bold crisp and high-contrast NOT washed-out NOT faded'),
  B('07031525', 'b07031525-popart-coils-woman', 155, 200, 22, 'popart', 'a beautiful woman with a full rounded halo of natural dark coily curls and elegant gold statement earrings, her face large and clearly centred and filling the frame with correct human proportions, both eyes clearly drawn, symmetrical, level and evenly spaced, each eye looking straight ahead at the viewer with a dark-brown iris and a single round black pupil centred in the MIDDLE of the eye (absolutely NOT cross-eyed, NOT looking sideways, pupils NOT shoved into the inner corners, NOT blank white eyes), clearly drawn dark eyebrows, a clearly defined nose with a visible bridge and nostrils, full defined lips, all facial features clearly and boldly outlined and fully visible on the dark skin, a calm confident warm expression, a smooth clear brown neck below the face, rich dark chocolate-brown skin (deep and clearly brown, absolutely not pink coral or orange), deep teal background', 1.1),
  B('07031525', 'b07031525-popart-earmuffs-woman', 150, 195, 20, 'popart', 'a cheerful young woman in cosy cream knitted earmuffs and a chunky scarf with light blonde hair, a warm friendly smile, her face clearly centred with correct proportions and both eyes symmetrical, clean smooth EVEN fair skin in a natural believable tone under bright FLAT even frontal lighting, soft flat even shading with absolutely NO grey or green blotches or contouring patches anywhere on the face or neck and NOT orange, dusty ice-blue background', 1.0),
  B('07031525', 'b07031525-face-ranunculus-fair', 160, 205, 26, 'artface', 'a woman with fair skin and a crown of layered peach, coral and cream ranunculus blooms with slender green foliage, painted in a clean FLAT even STYLISED way, a serene beautiful symmetrical face lit by bright FLAT even frontal studio light so the skin is ONE even flat matte tone with absolutely NO grey, green, brown or blue contouring shadows and NO dark hollows under the eyes and NO muddy patches anywhere on the face or neck, clean smooth even fair skin in a warm healthy peachy tone, the whole head and full forehead clearly visible above the brows, both eyes the same size symmetrical level and bright, soft flat even shading only', 1.0),
  B('07031525', 'b07031525-fantasy-dragon-garden', 145, 175, 30, 'fantasy', 'a cute chubby baby dragon with soft teal-and-lilac scales and tiny wings curled happily in a sunny cottage flower garden among tall foxgloves, daisies and roses with a butterfly on its nose, a friendly face with two NORMAL-SIZED symmetrical eyes each with a clearly drawn coloured iris and a distinct dark round pupil and a small white highlight (absolutely NOT blank empty eyes), bright vivid HIGH-CONTRAST jewel colours, crisp clean BOLD outlines, NOT hazy NOT washed-out NOT muddy'),
  B('07031525', 'b07031525-fantasy-fairy-moth', 145, 175, 30, 'fantasy', 'a pretty little woodland fairy with fair skin, delicate translucent wings and a soft green petal dress gently riding on the back of a large pale-green luna moth through a sunny flower meadow with drifting pollen and bluebells, a clear well-defined pretty face with a small nose and a sweet smile and two NORMAL-SIZED eyes (definitely NOT huge, NOT oversized) each with a clearly drawn coloured iris and a distinct dark round pupil and a small white highlight (absolutely NOT blank empty eyes, NOT solid orbs), both eyes symmetrical, bright vivid HIGH-CONTRAST luminous green-and-gold colours, crisp clean BOLD outlines, NOT hazy NOT washed-out NOT muddy'),
  B('07031525', 'b07031525-scene-rabbit-potter', 150, 190, 30, 'scene', 'a gentle grey rabbit potter in a clay-smudged apron sitting at a spinning wooden pottery wheel shaping a tall vase, both long ears up, shelves of finished blue-glazed pots and bowls behind, jars of tools and a bucket of water beside, a sunny cottage workshop with a big window and potted plants, warm and whimsical, plain pots with no lettering'),
  B('07031525', 'b07031525-scene-bear-cellist', 150, 190, 30, 'scene', 'a kindly brown bear cellist in a smart deep-blue waistcoat and bow tie sitting on a wooden chair playing a warm honey-toned cello with a bow, eyes closed contentedly, a music stand holding a blank sheet with no writing beside him, a cosy panelled parlour with a blue patterned rug, a green potted fern and a window of cool soft daylight, a calm balanced palette of blues, warm wood browns, green and cream with clearly SEPARATED distinct colours and absolutely NOT flooded in one orange tone, whimsical, blank sheet music with no lettering', 1.15),
  B('07031525', 'b07031525-bright-waxwing', 150, 170, 30, 'bright', 'a single plump waxwing bird with soft fawn-pink plumage, a jaunty crest, a black eye-mask and bright yellow-and-red wing tips, perched clearly on ONE simple branch to one side with a bold clean dark outline so the whole bird reads sharply against a clean plain white background, a small cluster of bright red berries and just two or three green leaves attached to that same branch, absolutely NO floating disconnected leaves and NO stray smudges, clean uncluttered composition, crisp and clear'),
  B('07031525', 'b07031525-big-amalfi-coast', 240, 220, 150, 'showpiece', 'a sun-drenched Italian Amalfi coast village of pastel lemon-yellow, coral-pink and terracotta houses tumbling down steep cliffs to a sparkling turquoise sea, cascading terraces of lemon trees and bright bougainvillea, a domed church, winding stone steps, little fishing boats on the water and cafe umbrellas, warm Mediterranean light, intricate richly-coloured full coverage'),
  B('07031525', 'b07031525-big-orchard-harvest', 235, 220, 150, 'showpiece', 'a golden autumn apple orchard harvest with heavily laden apple trees in red and green, wooden ladders leaning up, baskets and barrels brimming with red apples, a rustic stone cottage and a red wooden barn, pumpkins and hay bales, a horse and cart, drifting orange leaves and a warm amber sky, intricate saturated full coverage'),

  // ─────────── BATCH 07031620 (auto cron) ───────────
  B('07031620', 'b07031620-cute-baby-giraffe', 116, 120, 16, 'cute', 'an adorable baby giraffe with a soft pale-gold coat and gentle brown patches, tiny ossicone horns and a sweet round face, standing on a small solid patch of green grass with one little green acacia sprig, a VERY BOLD thick solid dark charcoal-brown outline drawn heavily as one strong continuous dark line all the way around the whole body, long neck, head and legs so the pale body stands out sharply on pale fabric and NO edge fades into the background, two clearly separated round dark eyes symmetrical and level and a tiny nose, bright and cheerful, plain white background, strong bold crisp and high-contrast NOT washed-out NOT faded'),
  B('07031620', 'b07031620-cute-baby-hippo', 116, 116, 15, 'cute', 'an adorable chubby baby hippo with soft blue-grey skin sitting happily in a small patch of calm bright blue water with a few little green lily pads and a tiny pink flower resting on its head, a sweet wide smiling face with two clearly separated round dark eyes symmetrical and level and two little round nostrils, a bold clear dark outline all the way around the rounded body and head so it reads crisply on pale fabric, bright and cheerful, plain white background, strong bold crisp NOT washed-out NOT muddy'),
  B('07031620', 'b07031620-cute-baby-skunk', 116, 118, 15, 'cute', 'a SINGLE adorable baby skunk sitting FACING forward on a small solid patch of green grass with a few tiny yellow flowers, exactly ONE clear round face with exactly two round dark eyes symmetrical and level and one small pink nose, ONE bold black body with a single clean white stripe running down the back and ONE fluffy upright tail, absolutely NO second face, NO extra eyes, NO extra limbs, clean uncluttered and clearly readable as one simple skunk, a bold clear dark outline, bright and cheerful, plain white background, strong bold crisp NOT muddy NOT jumbled'),
  B('07031620', 'b07031620-popart-bantuknots-woman', 155, 200, 22, 'popart', 'a beautiful woman with neat rounded bantu-knot hair buns arranged across the top of her head and elegant beaded gold earrings, her face large and clearly centred and filling the frame with correct human proportions, both eyes clearly drawn, symmetrical, level and evenly spaced, each eye looking straight ahead at the viewer with a dark-brown iris and a single round black pupil centred in the MIDDLE of the eye (absolutely NOT cross-eyed, NOT looking sideways, pupils NOT shoved into the inner corners, NOT blank white eyes), clearly drawn dark eyebrows, a clearly defined nose with a visible bridge and nostrils, full defined lips, all facial features clearly and boldly outlined and fully visible on the dark skin, a calm confident warm expression, a smooth clear brown neck below the face, rich dark chocolate-brown skin (deep and clearly brown, absolutely not pink coral or orange), matte EVEN skin with absolutely NO pink or rose blush circles or coloured patches on the cheeks and no rouge, warm mustard-yellow background', 1.1),
  B('07031620', 'b07031620-popart-highbun-glasses', 150, 195, 20, 'popart', 'a stylish young woman with sleek dark hair in a high top-knot bun wearing bold black cat-eye glasses and small gold stud earrings, a calm confident expression, her face clearly centred with correct proportions and both eyes symmetrical and level behind the glasses, clean smooth EVEN fair skin in a natural believable tone under bright FLAT even frontal lighting, soft flat even shading with absolutely NO grey or green blotches or contouring patches anywhere on the face or neck and NOT orange, dusty rose-pink background', 1.0),
  B('07031620', 'b07031620-face-cosmos-fair', 160, 205, 26, 'artface', 'a woman with fair skin and a crown of pink, magenta and white cosmos flowers with fine feathery green foliage, painted in a clean FLAT even STYLISED way, a serene beautiful symmetrical face lit by bright FLAT even frontal studio light so the ENTIRE face is ONE single even flat matte skin tone with identical lighting on BOTH sides and absolutely NO grey, green, brown or blue contouring shadows, NO darker shaded patch on either cheek or jaw and NO dark hollows under the eyes anywhere on the face or neck, clean smooth even fair skin in a warm healthy peachy tone, the whole head and full forehead clearly visible above the brows, both eyes the same size symmetrical level and bright, soft flat even shading only', 1.0),
  B('07031620', 'b07031620-fantasy-mermaid-lagoon', 150, 185, 30, 'fantasy', 'a pretty young mermaid with fair skin, long flowing auburn hair and a shimmering turquoise-and-violet scaled tail sitting on a smooth rock in a sunny tropical lagoon among bright coral, seashells and a friendly little orange clownfish, a clear pretty face with a small nose and a sweet smile and two SMALL NORMAL-SIZED realistic human eyes (definitely NOT big, NOT oversized, NOT huge anime eyes, NOT large black orbs) each with a clearly drawn coloured iris and a distinct small dark round pupil and a tiny white highlight, both eyes symmetrical, vivid saturated jewel colours with strong bold HIGH contrast, crisp clean BOLD outlines, NOT pale NOT hazy NOT washed-out NOT pastel'),
  B('07031620', 'b07031620-bright-chaffinch', 150, 170, 28, 'bright', 'a single plump chaffinch bird with a slate-blue crown, a warm salmon-pink breast, black-and-white wing bars and a pale beak, perched clearly on ONE simple branch to one side with a bold clean dark outline so the whole bird reads sharply against a clean plain white background, a small cluster of pink blossom and just two or three green leaves attached to that same branch, absolutely NO floating disconnected leaves and NO stray smudges, clean uncluttered composition, crisp and clear'),
  B('07031620', 'b07031620-scene-badger-bookseller', 150, 190, 30, 'scene', 'a friendly black-and-white badger bookseller in a cosy tweed waistcoat standing behind a wooden shop counter FACING the viewer holding an open book, one clear striped badger face looking forward with two symmetrical eyes and a black snout, tall shelves of colourful books rising behind him, a green desk lamp and a stack of books on the counter, a big window of soft daylight, warm and whimsical, all the book spines just plain blocks of colour with absolutely NO lettering or writing anywhere'),
  B('07031620', 'b07031620-scene-mouse-florist', 150, 190, 30, 'scene', 'a sweet little grey mouse florist in a green apron arranging a big bright bouquet at a wooden flower-shop counter surrounded by buckets and pots overflowing with colourful tulips, roses, sunflowers and daisies, hanging baskets and trailing ivy, a sunny shop window, warm and whimsical, all signs and labels left completely blank with absolutely NO lettering or writing anywhere'),
  B('07031620', 'b07031620-big-santorini-sunset', 240, 220, 150, 'showpiece', 'a breathtaking Greek Santorini village of whitewashed cubic houses with bright blue domed churches tumbling down the steep caldera cliffs to a deep sapphire sea, winding white steps and stone archways, pink bougainvillea spilling over walls, blue-shuttered windows, little boats far below and a warm golden sunset sky over the water, intricate richly-coloured full coverage'),
  B('07031620', 'b07031620-big-pumpkin-patch', 235, 220, 150, 'showpiece', 'a golden autumn pumpkin patch farm bursting with big orange pumpkins and gourds across the field, a rustic red barn and a white farmhouse, tall dried corn stalks and hay bales, sunflowers along a wooden fence, a horse-drawn hay cart, crates of red apples, a friendly scarecrow and drifting orange leaves under a warm amber sky, intricate saturated full coverage'),

  // ─────────── BATCH 07031721 (auto cron) ───────────
  // simple cuties — cool/well-marked (avoid pure-white ghost-out + brown-fur orange cook)
  B('07031721', 'b07031721-cute-tabby-kitten', 118, 118, 16, 'cute', 'an adorable fluffy grey tabby kitten with soft charcoal stripes and big round green eyes playing with a ball of bright blue yarn, sitting on a small solid patch of green grass, two clearly separated round eyes symmetrical and level and a tiny pink nose, a bold clear dark outline all the way around the rounded body, head, ears and tail so it reads crisply against the pale fabric, bright and cheerful, plain white background, strong bold crisp NOT washed-out NOT muddy'),
  B('07031721', 'b07031721-cute-piglet-puddle', 116, 116, 15, 'cute', 'an adorable happy pink piglet with rosy cheeks splashing in a small patch of calm bright blue water with a cheerful yellow rubber duck floating beside it, a sweet smiling face with two clearly separated round dark eyes symmetrical and level and a little round snout with two nostrils, a bold clear dark outline all the way around the plump rounded body so it stands out sharply on pale fabric, bright and cheerful, plain white background, strong bold crisp NOT washed-out NOT muddy'),
  B('07031721', 'b07031721-cute-duckling-boots', 114, 122, 15, 'cute', 'an adorable fluffy bright yellow duckling wearing little red rain boots and standing under a small red umbrella in a light spring shower, one clear round face with two clearly separated round dark eyes symmetrical and level and a small orange beak, a bold clear dark outline all the way around the fluffy body so it reads crisply on pale fabric, a few blue raindrops and a small green puddle, bright and cheerful, plain white background, strong bold crisp NOT washed-out'),
  // portraits — 1 deep-skin popart (sat 1.1, explicit irises), 1 fair popart (sat 1.0), 1 artface fair (sat 1.0)
  B('07031721', 'b07031721-popart-fulani-woman', 155, 200, 24, 'popart', 'a beautiful woman with elegant fulani braids parted neatly down the centre with fine gold beads and cowrie shells threaded through them and small gold hoop earrings, her face large and clearly centred and filling the frame with correct human proportions, both eyes clearly drawn, symmetrical, level and evenly spaced, each eye looking straight ahead at the viewer with a dark-brown iris and a single round black pupil centred in the MIDDLE of the eye (absolutely NOT cross-eyed, NOT looking sideways, pupils NOT shoved into the inner corners, NOT blank white eyes), clearly drawn dark eyebrows, a clearly defined nose with a visible bridge and nostrils, full defined lips, all facial features clearly and boldly outlined and fully visible on the dark skin, a calm confident warm expression, a smooth clear brown neck below the face, rich dark chocolate-brown skin (deep and clearly brown, absolutely not pink coral or orange), matte EVEN skin with absolutely NO pink or rose blush circles or coloured patches on the cheeks and no rouge, deep teal background', 1.1),
  B('07031721', 'b07031721-popart-pageboy-woman', 150, 195, 20, 'popart', 'a stylish young woman with a sleek glossy auburn pageboy bob with a neat fringe and small pearl earrings, a calm confident expression, her face clearly centred with correct proportions and both eyes symmetrical and level, clean smooth EVEN fair skin in a natural believable tone under bright FLAT even frontal lighting, soft flat even shading with absolutely NO grey or green blotches or contouring patches anywhere on the face or neck and NOT orange, soft sage-green background', 1.0),
  B('07031721', 'b07031721-face-primrose-fair', 160, 205, 26, 'artface', 'a beautiful woman with fair skin and a crown of soft pale-yellow and cream primroses with fine green leaves, painted in a clean SIMPLE FLAT poster style with large areas of ONE single solid even flat matte skin colour and NO painterly blending, lit by completely flat even frontal studio light so the whole face is filled with the SAME single peachy skin tone edge to edge with identical lighting on both sides, ABSOLUTELY NO grey, green, teal, brown or blue contouring shadows anywhere, NO darker shaded patches on the cheeks jaw temples or neck, NO dark hollows or sunken shadows under the eyes, NO tear-streaks or coloured marks below the eyes, clean smooth healthy warm peachy skin with soft rosy cheeks, full rounded not gaunt features, the whole head and full forehead clearly visible above the brows, both eyes the same size symmetrical level and bright with clear friendly expression, a gentle warm smile, flat even colour only', 1.0),
  // fantasy — bright, crisp, normal-sized symmetric eyes, NOT hazy, NOT all-dark
  B('07031721', 'b07031721-fantasy-fairy-pond', 150, 185, 30, 'fantasy', 'a pretty young fairy in a shimmering green dress with delicate translucent wings sitting on a bright green lily pad on a sparkling sunlit pond, a friendly blue dragonfly hovering nearby and pink water-lilies around her, a clear pretty face with a small nose and a sweet smile and two SMALL NORMAL-SIZED realistic eyes (definitely NOT big, NOT oversized, NOT huge anime eyes, NOT large black orbs) each with a clearly drawn coloured iris and a distinct small dark round pupil and a tiny white highlight, both eyes symmetrical, fair skin, vivid saturated jewel colours with strong bold HIGH contrast, crisp clean BOLD outlines, NOT pale NOT hazy NOT washed-out NOT pastel'),
  B('07031721', 'b07031721-fantasy-baby-dragon-stars', 135, 140, 28, 'fantasy', 'an adorable chubby baby dragon with smooth bright teal-and-violet scales, tiny wings and a sweet friendly face curled contentedly around a big glowing golden star in a bright twilight sky sprinkled with little sparkling stars, two big amber eyes that are clearly SYMMETRICAL level and the same size each with a round black pupil, a bold clear dark outline all around the body so it reads crisply, vivid saturated jewel colours with strong bold HIGH contrast on a bright deep-blue sky (NOT black, NOT all-dark), crisp clean BOLD outlines, NOT hazy NOT muddy NOT washed-out'),
  // whimsical animal-as-human scenes — grey/brown/green animals only (NO red/orange fur), blank signage
  B('07031721', 'b07031721-scene-tortoise-gardener', 150, 190, 30, 'scene', 'a gentle green tortoise gardener in a blue apron and a straw sun-hat watering rows of colourful potted flowers with a little watering can inside a sunny glass greenhouse, terracotta pots of tulips, daisies and green ferns on wooden staging, hanging baskets and trailing ivy, a wheelbarrow of soil, warm daylight through the glass, warm and whimsical, all little seed packets and plant labels left completely blank with absolutely NO lettering or writing anywhere'),
  B('07031721', 'b07031721-scene-cat-clockmaker', 150, 190, 30, 'scene', 'a dapper grey tabby cat clockmaker in a teal waistcoat and tiny round spectacles sitting upright at a tidy wooden workbench holding up one round pocket watch, one clear cat face looking forward with two symmetrical eyes and a pink nose, a bright cheerful workshop in clear warm daylight streaming through a big window, a wall behind neatly hung with a few colourful round mantel clocks and a cuckoo clock in clean separated blocks of red, blue, green and gold, one small green desk lamp and a few clearly-drawn brass cogs on the uncluttered bench, clean crisp bright HIGH-CONTRAST paint-by-numbers style with clearly SEPARATED colours and absolutely NOT dark NOT muddy NOT gloomy NOT flooded in one brown or orange tone, all clock faces and dials left as plain blank pale discs with absolutely NO numbers, NO lettering and NO writing anywhere', 1.15),
  // floral — bright bouquet
  B('07031721', 'b07031721-floral-cottage-bouquet', 155, 165, 30, 'bright', 'a generous bright cottage-garden bouquet arranged in a pretty blue-and-white ceramic jug, tall blue delphiniums, pink and magenta cosmos, orange and yellow dahlias, white daisies and sprigs of green foliage, a cheerful multicolour full arrangement with bold clean outlines and crisp clear petals, high contrast against a clean plain white background, clean uncluttered composition'),
  // huge dense showpieces — colours 150 → Flux 1.1 Pro, 100+ floss
  B('07031721', 'b07031721-big-swiss-alps-winter', 240, 220, 150, 'showpiece', 'a bright cheerful snowy Swiss alpine winter village in clear daytime light, wooden chalets with deep snow-laden roofs and warm glowing golden windows, tall snow-dusted fir trees, a little frozen lake with tiny skaters and a snowman, a red mountain railway winding through, church steeple, smoking chimneys, children sledging, towering white mountain peaks behind and a soft pink-and-blue winter sky, crisp and bright NOT dark NOT gloomy, intricate richly-coloured full coverage'),
  B('07031721', 'b07031721-big-tropical-waterfall', 235, 220, 150, 'showpiece', 'a lush tropical rainforest paradise with a tall turquoise waterfall cascading into a clear aquamarine pool, dense green jungle foliage, giant ferns and palms, vivid orchids and hibiscus in pink, orange and red, colourful parrots and a toucan in the branches, bright blue butterflies, a playful monkey, mossy rocks and vines, dappled golden sunlight, intricate saturated full coverage'),

  // ─────────── BATCH 07031820 (auto cron) ───────────
  // simple cuties — well-marked / self-contrasting (avoid pure-white ghost-out + brown/ginger orange cook)
  B('07031820', 'b07031820-cute-meerkat-pup', 116, 120, 16, 'cute', 'an adorable baby meerkat sitting upright on a small solid patch of warm sandy ground with rich deep tan-and-brown fur (NOT pale, NOT washed-out, NOT ghostly), a sweet friendly face with two clearly separated CLEAN round dark eyes each with a small white highlight, symmetrical and level and NOT smudged and NOT merged into the dark eye patches, a small dark nose and a tiny smile, a bold thick dark charcoal outline all the way around the rounded upright body, head, ears and long tail so it reads crisply and stands out sharply against the pale fabric, bright and cheerful, plain white background, strong bold crisp NOT washed-out NOT muddy'),
  B('07031820', 'b07031820-cute-dormouse-berry', 114, 114, 15, 'cute', 'an adorable tiny dormouse with soft warm-brown fur and a paler cream tummy holding a single bright red berry in its little paws, a sweet smiling face with two clearly separated round dark eyes symmetrical and level, big round ears and a small pink nose, sitting on a small green leaf, a bold clear dark outline all the way around the plump rounded body and curled tail so it stands out sharply on pale fabric, bright and cheerful, plain white background, strong bold crisp NOT washed-out NOT muddy'),
  B('07031820', 'b07031820-cute-baby-donkey', 116, 122, 16, 'cute', 'an adorable fuzzy soft-grey baby donkey with big floppy ears and a darker charcoal mane standing in a small patch of bright yellow buttercups, a sweet friendly face with two clearly separated round dark eyes symmetrical and level and a soft grey muzzle, a bold clear dark outline all the way around the fluffy rounded body so it reads crisply against the pale fabric, bright and cheerful, plain white background, strong bold crisp NOT washed-out NOT muddy'),
  // portraits — 1 deep-skin popart (sat 1.1, explicit irises), 1 fair popart (sat 1.0), 1 artface fair (sat 1.0)
  B('07031820', 'b07031820-popart-twistout-woman', 155, 200, 24, 'popart', 'a beautiful woman with a full voluminous rounded twist-out afro hairstyle and elegant gold statement hoop earrings, her face large and clearly centred and filling the frame with correct human proportions, both eyes clearly drawn, symmetrical, level and evenly spaced, each eye looking straight ahead at the viewer with a dark-brown iris and a single round black pupil centred in the MIDDLE of the eye (absolutely NOT cross-eyed, NOT looking sideways, pupils NOT shoved into the inner corners, NOT blank white eyes), clearly drawn dark eyebrows, a clearly defined nose with a visible bridge and nostrils, full defined lips with a warm confident smile, all facial features clearly and boldly outlined and fully visible on the dark skin, a smooth clear brown neck below the face, rich warm even chocolate-brown skin (deep and clearly brown, NOT grey, NOT ashy, NOT muddy, absolutely not pink coral or orange), completely matte EVEN skin all ONE single flat brown tone edge to edge, the cheeks the EXACT SAME even brown as the rest of the face, absolutely NO blusher, NO rosy or pink cheeks, NO pink or rose blush circles, NO coloured patches or rouge anywhere on the face, warm mustard-gold background', 1.1),
  B('07031820', 'b07031820-popart-wavybob-woman', 150, 195, 20, 'popart', 'a stylish young woman with a chic glossy shoulder-length wavy brunette bob and bold red lipstick and small gold stud earrings, a calm confident expression, her face clearly centred with correct proportions and both eyes symmetrical and level, clean smooth EVEN fair skin in a natural believable tone under bright FLAT even frontal lighting, soft flat even shading with absolutely NO grey or green blotches or contouring patches anywhere on the face or neck and NOT orange, soft dusty-rose background', 1.0),
  B('07031820', 'b07031820-face-jasmine-fair', 160, 205, 26, 'artface', 'a beautiful woman with fair skin and a crown of delicate white star jasmine blossoms with fine green leaves, shown zoomed OUT so the ENTIRE head is fully visible from the very top of the hair down to the shoulders with clear margin all around, the face turned directly FORWARD looking straight at the viewer, perfectly symmetrical and centred, the whole forehead completely visible above the eyebrows and NOT cropped, painted in a clean SIMPLE FLAT poster style with large areas of ONE single solid even flat matte skin colour and NO painterly blending, lit by completely flat even frontal studio light so the whole face is filled with the SAME single peachy skin tone edge to edge with identical lighting on both sides, ABSOLUTELY NO grey, green, teal, brown or blue contouring shadows anywhere, NO darker shaded patches on the cheeks jaw temples or neck, NO dark hollows or sunken shadows under the eyes, NO tear-streaks or coloured marks below the eyes, clean smooth healthy warm peachy skin with soft rosy cheeks, full rounded not gaunt features, both eyes the same size symmetrical level and bright with a clear friendly expression, a gentle warm smile, flat even colour only', 1.0),
  // fantasy — bright, crisp, normal-sized symmetric eyes, NOT hazy, NOT all-dark
  B('07031820', 'b07031820-fantasy-dragon-rainbow', 140, 145, 30, 'fantasy', 'an adorable chubby baby rainbow dragon with smooth glossy scales shading softly from red through orange, yellow, green, blue to violet, tiny flapping wings and a sweet friendly face perched happily on a fluffy white cloud puffing a few tiny sparkling stars, TWO eyes drawn EXACTLY the same medium size, both perfectly symmetrical and level and evenly spaced, each a clean round eye with a clear coloured iris and a single small round black pupil and a tiny white highlight — absolutely NOT one big black orb, absolutely NOT one eye larger than the other, NOT a black smudge or blob, NOT huge anime eyes, a bold clear dark outline all around the plump body so it reads crisply, a bright sunny blue sky with a soft rainbow arc behind, vivid saturated jewel colours with strong bold HIGH contrast, crisp clean BOLD outlines, NOT hazy NOT muddy NOT washed-out NOT all-dark'),
  B('07031820', 'b07031820-fantasy-fairy-sunflower', 135, 165, 28, 'fantasy', 'a pretty young flower fairy in a golden petal dress with delicate translucent wings sitting happily on top of a giant bright sunflower in a sunny summer meadow, a cheerful bumblebee and a blue butterfly nearby, a clear pretty face with a small nose and a sweet smile and two SMALL NORMAL-SIZED realistic eyes (definitely NOT big, NOT oversized, NOT huge anime eyes, NOT large black orbs) each with a clearly drawn coloured iris and a distinct small dark round pupil and a tiny white highlight, both eyes symmetrical, fair skin, vivid saturated jewel colours with strong bold HIGH contrast, crisp clean BOLD outlines, NOT pale NOT hazy NOT washed-out NOT pastel'),
  // whimsical animal-as-human scenes — grey/brown/black-and-white animals only (NO red/orange/ginger fur), blank signage
  B('07031820', 'b07031820-scene-hedgehog-baker', 150, 190, 30, 'scene', 'a cheerful little brown hedgehog baker in a red-striped apron and a white baker hat holding up a tray of freshly baked golden muffins inside a warm cosy bakery, FACING the viewer with one clear friendly face and two symmetrical eyes and a tiny black nose, a bright tidy uncluttered counter with a few colourful cupcakes and a bowl of dough, cool teal and green painted cupboards and shelves behind with clean SEPARATED blocks of blue, green, red and cream jars and loaves, clear bright daylight through a window, cheerful paint-by-numbers style with clearly SEPARATED bright colours and a balanced warm-and-cool palette, absolutely NOT flooded in one yellow or orange tone, NOT hazy NOT washed-out NOT muddy, all little jar labels and recipe cards left completely blank with absolutely NO lettering or writing anywhere', 1.15),
  B('07031820', 'b07031820-scene-penguin-postman', 150, 190, 28, 'scene', 'a cheerful little penguin postman in a smart blue cap and satchel carrying a bundle of colourful wrapped parcels down a bright snowy village lane, FACING the viewer with one clear friendly face and two symmetrical eyes and a small orange beak, cosy cottages with warm glowing windows and snow-dusted roofs on either side, a little red post-box, soft falling snow and a bright crisp blue winter sky, cheerful paint-by-numbers style with clearly SEPARATED bright colours NOT dark NOT muddy, all parcel labels and the post-box left completely blank with absolutely NO lettering or writing anywhere'),
  // bird — bright saturated multicolour
  B('07031820', 'b07031820-bright-jay', 150, 160, 26, 'bright', 'a bright Eurasian jay with its distinctive pinkish-brown body, bold black-and-white wings and vivid electric-blue barred wing patch perched on a gnarled oak branch with green leaves and a few brown acorns, crisp clean bold outlines, bold saturated multicolour palette, high contrast against a clean plain white background, clean uncluttered composition'),
  // huge dense showpieces — colours 150 → Flux 1.1 Pro, 100+ floss
  B('07031820', 'b07031820-big-cotswolds-village', 240, 220, 150, 'showpiece', 'a charming sunlit Cotswolds stone village high street in bright summer daylight, rows of honey-coloured cottages with steep roofs and climbing roses, colourful hanging flower baskets and window boxes spilling with blooms, little shopfronts with striped awnings, a stone bridge over a clear stream with ducks, a red telephone box, a village green with a big leafy tree, rolling green hills and a soft blue sky behind, crisp and bright NOT dark NOT gloomy, intricate richly-coloured full coverage, all shop signs left blank with no lettering'),
  B('07031820', 'b07031820-big-lighthouse-cove', 235, 220, 150, 'showpiece', 'a bright sunlit coastal lighthouse scene, a tall red-and-white striped lighthouse standing on a rocky green headland above a turquoise sea, little white-and-blue fishing boats bobbing in a sheltered cove, a cluster of cheerful pastel harbour cottages, wheeling white gulls, wildflowers and gorse on the cliffs, a wooden jetty with lobster pots, a few puffins on the rocks, foamy waves and a bright clear blue sky with soft clouds, crisp and bright, intricate saturated full coverage'),
  // ===== BATCH 07031921 =====
  // cuties — self-contrasting colours only (NO pure-white ghost-out, NO ginger fur), symmetric eyes, bold outline
  B('07031921', 'b07031921-cute-mouse-strawberry', 114, 116, 15, 'cute', 'an adorable tiny soft-grey mouse holding a single big bright red strawberry in its little paws, a sweet smiling face with two clearly separated round dark eyes symmetrical and level, big round pink-lined ears, a tiny pink nose and long whiskers, sitting on a small green leaf, a bold clear dark outline all the way around the plump rounded body and curled tail so it stands out sharply on pale fabric, bright and cheerful, plain white background, strong bold crisp NOT washed-out NOT muddy'),
  B('07031921', 'b07031921-cute-piglet-clover', 116, 116, 15, 'cute', 'an adorable chubby bright-pink baby piglet with rosy cheeks sitting happily in a small patch of bright green clover and tiny white flowers, a sweet friendly face with two clearly separated round dark eyes symmetrical and level, big floppy ears and a little curly tail and a round snout, a bold clear dark outline all the way around the plump rounded body so it reads crisply against the pale fabric, bright and cheerful, plain white background, strong bold crisp NOT washed-out NOT muddy'),
  B('07031921', 'b07031921-cute-frog-lilypad', 116, 114, 15, 'cute', 'an adorable cheerful bright-green baby frog sitting on a round green lily pad on calm blue water with a small pink water lily beside it, a sweet smiling face with two clearly separated round dark eyes symmetrical and level and a wide friendly smile, smooth green skin with a paler cream tummy, a bold clear dark outline all the way around the rounded body and legs so it stands out sharply on pale fabric, bright and cheerful, plain white background, strong bold crisp NOT washed-out NOT muddy'),
  // portraits — 1 deep-skin popart (sat 1.1, explicit even brown + symmetric forward irises), 1 fair popart (sat 1.0), 1 artface fair (sat 1.0)
  B('07031921', 'b07031921-popart-goldhoops-woman', 155, 200, 24, 'popart', 'a beautiful woman with a neat short tapered natural afro and elegant large gold hoop earrings, her face large and clearly centred and filling the frame with correct human proportions, both eyes clearly drawn, symmetrical, level and evenly spaced, each eye looking straight ahead at the viewer with a dark-brown iris and a single round black pupil centred in the MIDDLE of the eye (absolutely NOT cross-eyed, NOT looking sideways, pupils NOT shoved into the inner corners, NOT blank white eyes), clearly drawn dark eyebrows, a clearly defined nose with a visible bridge and nostrils, full defined lips with a warm confident smile, all facial features clearly and boldly outlined and fully visible on the dark skin, a smooth clear brown neck below the face, rich warm even chocolate-brown skin (deep and clearly brown, NOT grey, NOT ashy, NOT muddy, absolutely not pink coral or orange), completely matte EVEN skin all ONE single flat brown tone edge to edge, the cheeks the EXACT SAME even brown as the rest of the face, absolutely NO blusher, NO rosy or pink cheeks, NO pink or rose blush circles, NO coloured patches or rouge anywhere on the face, warm teal background, the entire face one perfectly uniform flat brown with the cheeks IDENTICAL to the forehead and jaw, absolutely NO red, NO rose, NO dusty-pink, NO magenta and NO darker circular patches on the cheeks whatsoever', 1.1),
  B('07031921', 'b07031921-popart-sleekbun-woman', 150, 195, 20, 'popart', 'a stylish elegant young woman with a sleek glossy dark low bun and bold red lipstick and small gold stud earrings, a calm confident expression, her face clearly centred with correct proportions and both eyes symmetrical and level, clean smooth EVEN fair skin in a natural believable tone under bright FLAT even frontal lighting, soft flat even shading with absolutely NO grey or green blotches or contouring patches anywhere on the face or neck and NOT orange, soft dusty-blue background', 1.0),
  B('07031921', 'b07031921-face-freesia-fair', 160, 205, 26, 'artface', 'a beautiful woman with fair skin and a crown of delicate white and soft-yellow freesia blossoms with fine green leaves, shown zoomed OUT so the ENTIRE head is fully visible from the very top of the hair down to the shoulders with clear margin all around, the face turned directly FORWARD looking straight at the viewer, perfectly symmetrical and centred, the whole forehead completely visible above the eyebrows and NOT cropped, painted in a clean SIMPLE FLAT poster style with large areas of ONE single solid even flat matte skin colour and NO painterly blending, lit by completely flat even frontal studio light so the whole face is filled with the SAME single peachy skin tone edge to edge with identical lighting on both sides, ABSOLUTELY NO grey, green, teal, brown or blue contouring shadows anywhere, NO darker shaded patches on the cheeks jaw temples or neck, NO dark hollows or sunken shadows under the eyes, NO tear-streaks or coloured marks below the eyes, clean smooth healthy warm peachy skin with soft rosy cheeks, full rounded not gaunt features, both eyes the same size symmetrical level and bright with a clear friendly expression, a gentle warm smile, flat even colour only', 1.0),
  // fantasy — bright, crisp, controlled symmetric NORMAL-sized eyes, NOT hazy, NOT all-dark
  B('07031921', 'b07031921-fantasy-fairy-bluebell', 135, 165, 28, 'fantasy', 'a pretty young flower fairy in a soft blue-violet petal dress with delicate translucent wings sitting happily among a cluster of tall blue bluebell flowers in a sunny spring wood, a friendly ladybird nearby, a clear pretty face with a small nose and a sweet smile and two SMALL NORMAL-SIZED realistic eyes (definitely NOT big, NOT oversized, NOT huge anime eyes, NOT large black orbs) each with a clearly drawn coloured iris and a distinct small dark round pupil and a tiny white highlight, both eyes symmetrical and level, fair skin, vivid saturated jewel colours with strong bold HIGH contrast, crisp clean BOLD outlines, NOT pale NOT hazy NOT washed-out NOT pastel'),
  B('07031921', 'b07031921-fantasy-dragon-flowers', 140, 145, 30, 'fantasy', 'an adorable chubby friendly bright-green-and-teal baby dragon with smooth glossy scales and tiny flapping wings sitting happily in a cheerful sunny flower meadow full of bright red, pink and yellow blooms, TWO eyes drawn EXACTLY the same medium size, both perfectly symmetrical and level and evenly spaced, each a clean round eye with a clear amber iris and a single small round black pupil and a tiny white highlight — absolutely NOT one big black orb, absolutely NOT one eye larger than the other, NOT a black smudge or blob, NOT huge anime eyes, a bold clear dark outline all around the plump body so it reads crisply, a bright sunny blue sky behind, vivid saturated jewel colours with strong bold HIGH contrast, crisp clean BOLD outlines, NOT hazy NOT muddy NOT washed-out NOT all-dark'),
  // whimsical animal-as-human scenes — grey/brown animals only (NO red/orange/ginger fur), blank signage, balanced palette
  B('07031921', 'b07031921-scene-otter-baker', 150, 190, 30, 'scene', 'a cheerful little brown otter baker in a blue-striped apron and a white baker hat holding up a tray of freshly baked golden bread rolls inside a warm cosy bakery, FACING the viewer with one clear friendly face and two symmetrical eyes and a small dark nose, a bright tidy uncluttered counter with a few colourful cupcakes and a bowl of dough, cool teal and green painted cupboards and shelves behind with clean SEPARATED blocks of blue, green, red and cream jars and loaves, clear bright daylight through a window, cheerful paint-by-numbers style with clearly SEPARATED bright colours and a balanced warm-and-cool palette, absolutely NOT flooded in one yellow or orange tone, NOT hazy NOT washed-out NOT muddy, all little jar labels and recipe cards left completely blank with absolutely NO lettering or writing anywhere', 1.15),
  B('07031921', 'b07031921-scene-koala-librarian', 150, 190, 28, 'scene', 'a cheerful little grey koala librarian in a smart little waistcoat and round glasses holding an open book inside a cosy warm library, FACING the viewer with one clear friendly face and two symmetrical eyes and a big dark round nose, tall wooden shelves behind filled with clearly SEPARATED blocks of red, blue, green, teal and mustard book spines, a little green desk lamp with a warm glow, a comfy armchair, cheerful paint-by-numbers style with clearly SEPARATED bright balanced colours NOT dark NOT muddy NOT flooded in one brown tone, all the book spines and labels left completely blank with absolutely NO lettering or writing anywhere'),
  // bird — bright saturated multicolour
  B('07031921', 'b07031921-bright-yellowhammer', 150, 160, 26, 'bright', 'a bright yellowhammer bird with its vivid golden-yellow head and breast, streaky chestnut-brown back and wings perched on a slender green hedgerow branch with a few white hawthorn blossoms, crisp clean bold outlines, bold saturated multicolour palette, high contrast against a clean plain white background, clean uncluttered composition'),
  // huge dense showpieces — colours 150 → Flux 1.1 Pro, 100+ floss
  B('07031921', 'b07031921-big-provence-market', 240, 220, 150, 'showpiece', 'a bright sunlit Provençal village market square in summer daytime, colourful striped market stalls piled high with lavender bunches, sunflowers, ripe tomatoes, lemons, cheeses and baskets of bread, honey-stone houses with pale blue shutters and terracotta roofs and climbing bougainvillea, cheerful shoppers with baskets, a stone fountain, potted olive trees, bunting strung overhead, rolling purple lavender fields and a soft blue sky behind, crisp and bright NOT dark NOT gloomy, intricate richly-coloured full coverage, all stall signs left blank with no lettering'),
  B('07031921', 'b07031921-big-scottish-highlands', 235, 220, 150, 'showpiece', 'a bright sunlit Scottish Highlands scene in summer daylight, a shimmering blue loch reflecting the sky, a grand grey stone castle on a green hillside, shaggy ginger-brown highland cattle grazing in the foreground meadow, rolling green and purple heather-covered hills and distant blue mountains, a little white-washed croft cottage with a smoking chimney, a rushing stream with a small stone bridge, pine trees and yellow gorse, a few sheep, a bright clear blue sky with soft clouds, crisp and bright, intricate saturated full coverage'),

  // ===== BATCH 07032021 =====
  // simple cuties — self-contrasting coloured animals (no pure-white ghost-out, no ginger fur), symmetric eyes
  B('07032021', 'b07032021-cute-mole-flower', 115, 115, 15, 'cute', 'an adorable chubby grey velvet mole sitting up in green grass, a clear friendly face with two small symmetrical black eyes and a little pink nose and a bold clean dark outline, holding ONE single bright pink flower in its tiny pink paws, soft plain grey fur with NO extra spots or patches anywhere on its body, reads clearly against the pale fabric, NOT washed-out NOT muddy, clean simple uncluttered composition, clean white background'),
  B('07032021', 'b07032021-cute-baby-walrus', 118, 115, 16, 'cute', 'an adorable roly-poly baby walrus sitting on a pale blue ice floe with two tiny white tusks and little flippers, soft blue-grey skin with a clear soft dark outline so it reads on pale fabric, rosy cheeks and a sweet smiling face with a big whiskery muzzle and two symmetrical black eyes, a little bright silver fish beside it and blue water for contrast, lots of personality, clean simple composition, clean white background'),
  B('07032021', 'b07032021-cute-baby-tortoise', 112, 112, 14, 'cute', 'an adorable tiny baby tortoise with a bright patterned orange-and-gold domed shell, a clear friendly face with two symmetrical black eyes and little stubby legs, a bold clean dark outline, sitting on a small brown log with one little green sprig, warm orange gold and brown colours that stand out clearly and DO NOT blend into the background, NOT muddy NOT washed-out, lots of personality, clean simple uncluttered composition, clean white background'),
  // portraits — 1 deep-skin popart (sat 1.1), 1 fair popart (sat 1.0), 1 fair artface flower-crown (sat 1.0)
  B('07032021', 'b07032021-popart-hibiscus-woman', 155, 200, 24, 'popart', 'a striking minimalist flat pop-art portrait of a beautiful woman with rich dark chocolate-brown skin (deep and clearly brown, absolutely not pink coral or orange), short natural black coils with a single bright red hibiscus flower tucked behind one ear, bold gold hoop earrings, a calm elegant expression, a calm elegant expression looking STRAIGHT AT THE VIEWER with both eyes exactly symmetrical and the pupils centred in the MIDDLE of each eye NOT looking to the side NOT cross-eyed NOT showing whites, her cheeks the exact same even brown as her forehead with absolutely NO pink rosy or mauve blush patches or circles anywhere, the whole head and full forehead clearly visible, clean flat areas of solid colour, a simple soft teal background, elegant and stylish', 1.1),
  B('07032021', 'b07032021-popart-windswept-woman', 155, 200, 22, 'popart', 'a striking minimalist flat pop-art portrait of a beautiful woman with fair skin and long windswept honey-blonde hair flowing to one side, clean smooth even skin in one flat tone with NO grey contouring shadows and NO orange, a calm elegant expression, both eyes exactly symmetrical, the whole head and full forehead clearly visible, clean flat areas of solid colour, a simple soft coral-pink background, elegant and stylish', 1.0),
  B('07032021', 'b07032021-face-buttercup-fair', 160, 205, 26, 'artface', 'a serene beautiful face with FAIR PALE skin adorned with a crown of bright yellow buttercups and green leaves, in bright FLAT even studio lighting with NO grey contouring shadows, clean smooth even skin in one single flat tone, the whole head and full forehead clearly visible above the brows, both eyes symmetrical, no grey shadows or patches on the face, sophisticated rich harmonious yellow-and-green palette, plain soft background, gallery-art feel, stylised NOT photographic', 1.0),
  // fantasy — bright crisp bold outlines, symmetric normal-sized eyes, NOT dark NOT muddy
  B('07032021', 'b07032021-fantasy-dragon-teacup', 135, 135, 28, 'fantasy', 'an enchanting storybook illustration of a tiny adorable bright teal-green baby dragon sitting up inside a pretty floral teacup FACING the viewer with a clear friendly face and TWO symmetrical round eyes each with a small highlight, a bold clean dark outline, bright jewel-tone teal and gold scales, little folded wings and tiny horns, a wisp of steam, two pink roses beside the saucer, whimsical and charming, crisp and bright and clearly defined, absolutely NOT hazy NOT washed-out NOT muddy, clean white background'),
  B('07032021', 'b07032021-fantasy-fairy-firefly', 145, 155, 30, 'fantasy', 'an enchanting storybook illustration of a sweet little fairy in a bright lilac dress with delicate glittering wings, dancing among softly glowing golden fireflies in a bright twilight meadow of bluebells, a clear pretty well-defined face with rosy cheeks and a sweet smile and TWO symmetrical NORMAL-sized eyes each with a clear coloured iris and a defined dark pupil and a small highlight, absolutely NOT big blank empty pale eyes, soft glowing magical light but BRIGHT and clear NOT dark NOT all-black, crisp clean bold outlines, rich saturated jewel-tone fills, whimsical and charming, NOT muddy NOT hazy'),
  // whimsical animal-as-human scenes — grey/white animals only (NO red/ginger fur), blank signage, balanced palette
  B('07032021', 'b07032021-scene-mouse-cheesemonger', 150, 190, 30, 'scene', 'a cheerful little grey mouse cheesemonger in a blue-and-white striped apron holding up a wedge of golden cheese inside a bright cosy cheese shop, FACING the viewer with one clear friendly face and two symmetrical eyes and a small pink nose, a tidy uncluttered wooden counter with clearly SEPARATED wheels of yellow, cream and pale-orange cheese and a few green grapes, cool blue-green painted shelves behind with clean SEPARATED blocks of colour, clear bright daylight through a window, cheerful paint-by-numbers style with clearly SEPARATED bright balanced colours NOT flooded in one yellow tone NOT hazy NOT muddy, all little price cards and labels left completely blank with absolutely NO lettering or writing anywhere', 1.15),
  B('07032021', 'b07032021-scene-duck-greengrocer', 150, 190, 30, 'scene', 'a cheerful plump white-and-yellow duck greengrocer in a green apron holding a wicker basket of fresh vegetables outside a bright cosy greengrocer shop, FACING the viewer with one clear friendly face and two symmetrical eyes and an orange bill, tidy wooden crates of clearly SEPARATED red tomatoes, orange carrots, green cabbages, purple aubergines and yellow lemons, a striped awning above, cool teal-painted shopfront behind, clear bright daylight, cheerful paint-by-numbers style with clearly SEPARATED bright balanced colours NOT flooded in one tone NOT muddy, all little chalkboard signs and crate labels left completely blank with absolutely NO lettering or writing anywhere'),
  // floral — bright saturated multicolour
  B('07032021', 'b07032021-floral-cosmos-jug', 150, 165, 30, 'bright', 'a cheerful bouquet of bright pink, white and magenta cosmos flowers with feathery green foliage arranged in a rustic blue-and-white ceramic jug, a few buds and a fallen petal on the table, crisp clean bold outlines, bold saturated multicolour palette, high contrast against a clean plain white background, clean uncluttered composition'),
  // huge dense showpieces — colours 150 → Flux 1.1 Pro, 100+ floss
  B('07032021', 'b07032021-big-nordic-fjord', 240, 220, 150, 'showpiece', 'a bright sunlit Norwegian fjord village in summer daytime, deep blue fjord water reflecting the sky, clusters of red-painted and yellow wooden cabins with green grass roofs along the shore, a tall silvery waterfall cascading down a green mountainside, little fishing boats and a red rowing boat on the water, snow-capped blue mountains behind, pine forests, wildflower meadows, a wooden jetty, a few sheep, clear bright blue sky with soft clouds, crisp and bright NOT dark NOT gloomy, intricate richly-coloured full coverage, all signs left blank with no lettering'),
  B('07032021', 'b07032021-big-rice-terraces', 235, 220, 150, 'showpiece', 'a bright sunlit tropical rice-terrace valley in summer daylight, brilliant emerald-green stepped rice paddies curving down a hillside reflecting the sky, a little village of thatched huts and a red-and-gold temple with tiered roofs, tall palm trees and banana plants, farmers in conical hats and a water buffalo, a winding blue stream and a small wooden bridge, tropical flowers and butterflies, distant misty green mountains, clear bright blue sky, crisp and bright, intricate saturated full coverage, all signs left blank with no lettering'),
]
