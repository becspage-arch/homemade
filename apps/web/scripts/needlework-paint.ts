...
const JOBS: Record<string, Job> = {
  ...
  strawberries: { slug: 'strawberries', name: 'Strawberries', description: 'A cluster of ripe strawberries with blossom and leaves — a sweet botanical.', prompt: 'a highly detailed naturalistic illustration of a cluster of ripe red strawberries with white blossoms and green leaves' + PLAIN, frame: 'round', widthMm: 175, tameWarm: true, detail: true },
  ...
  singletulip: { slug: 'singletulip', name: 'Single Tulip', description: 'A single tulip on a stem — a delicate line motif on bare linen.', prompt: 'a simple delicate botanical illustration of a single pink tulip flower on a green stem with two leaves' + DELICATE, mode: 'line', frame: 'round', widthMm: 150 },
