...
export function TutorialForm({
  ...
  const [type, setType] = useState<'RECIPE' | 'TECHNIQUE' | 'PRACTICE' | 'READING' | 'GROWING_GUIDE'>(defaults.type)
      ...
      <div className="grid gap-6 sm:grid-cols-[1fr_2fr]">
        <label className="block">
          ...
          <Select
            name="type"
            value={type}
            onChange={(v) => setType(v as 'RECIPE' | 'TECHNIQUE' | 'PRACTICE' | 'READING' | 'GROWING_GUIDE')}
