    ...
    recipe.builder === 'shaped'
      ...
      : recipe.builder === 'round'
        ...
        : recipe.builder === 'sphere'
          ...
          : recipe.builder === 'knit'
            ? buildKnit(recipe.rows, W, yr, recipe.knitFace ?? (recipe.knitFlip ? 'garter' : 'stockinette'), recipe.knitGaugeScale ?? 1, recipe.knitCourseScale ?? 1, recipe.knitStitch, recipe.knitCables)
