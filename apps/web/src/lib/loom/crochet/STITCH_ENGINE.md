...
| **scinc** (2 sc in one st, shaped rows) | growing trapezoid, inc both ends every row; two full audited hooks share one below-crown, legs fan from the base (§8c) | ◔ audit-clean (90/90) after three numerically-diagnosed construction fixes (turning chain every row; over-the-base-first order; side-by-side hook inits; full-width lattice). Rendered 2026-07-10 (gate 0.926): shape + fanned edge pairs read; one blemish — the foundation edge rolls into a heavy lip. Awaiting Rebecca. |
