// Ease presets - how much extra (or negative) circumference the finished
// garment carries over the body measurement. Crochet ease conventions
// follow the same scale as knitting; values picked to match common
// indie-designer ease tables.
//
// Ease is applied to bust / chest. Hip and waist scale proportionally
// within the construction-shape modules.
...
export interface EaseDescriptor {
  /** Centimetres added to bust circumference. Negative values shrink. */
  amountCm: number
